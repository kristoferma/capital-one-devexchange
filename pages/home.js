  ...
  <div>
    <nav className="navbar navbar-expand-md bg-primary navbar-dark">
      <div className="container">
        ...
        >
          <a className="btn navbar-btn btn-primary ml-2 text-white">
        ...
        <div className="collapse navbar-collapse" id="navbarSupportedContent">
          <ul className="navbar-nav mr-auto">
            <li className="nav-item">
              <a className="nav-link" href="/create-coupon">
                Create
              </a>
            </li>
          </ul>
    ...
    <div className="p-5 text-center bg-secondary gradient-overlay">
      <div className="container">
        <div className="row">
        {object.url.query.map(coupon => (
          <div className="col-md-3">
            <div className="card p-5 m-1">
              ...
              <div className="card-block my-3">
                <h1>
                  <b>{coupon.streakCount}</b> day
                </h1>
                each <i>{coupon.timeframe}</i>
                <hr />
                <p>
                  <b>{coupon.minimumTransaction}</b> minimum
                </p>
                <hr />
                <p>
                  <b>{coupon.discount}</b> Discount
                </p>
                <hr />
                <p>
                  Expiration date: <b>{new Date(coupon.expirationDate).toLocaleDateString()}</b>
                </p>
              </div>
              <div className="card-block">
