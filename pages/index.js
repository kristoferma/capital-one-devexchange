      ...
      <div className="col-md-6">
        <div className="card text-white p-5 bg-primary">
          <div className="card-body">
            <h1 className="mb-4">Merchant Login</h1>
            <form action="/login" method="post">
              <div className="form-group">
                <label>Client ID</label>
                <input className="form-control" name="client_id" value="vgw3sf4f8nq3b98i1gdfr8wpx4gpty0ska52" />
              </div>
              <div className="form-group"> <label>Client Secret</label>
                <input className="form-control" name="client_secret" type="password"
          value="eb5f6rda6v0d1ld8y4fymkudo86gorrc47cj"/> </div>
